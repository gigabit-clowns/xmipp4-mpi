...
#include "communication/mpi/mpi_host_communicator_backend.hpp"
...
void mpi_plugin::register_at(service_catalog& catalog) const
{
	auto& communicator_manager = 
		catalog.get_service_manager<communication::host_communicator_manager>();
	
	communication::mpi_host_communicator_backend::register_at(
