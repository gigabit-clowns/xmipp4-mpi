...
#include "mpi_host_scatter_operation.hpp"
...
mpi_host_scatter_operation::mpi_host_scatter_operation(
...
void mpi_host_scatter_operation::execute()
{
	const auto err = MPI_Scatter(
		m_send_data,
		m_send_count,
		m_send_datatype,
		m_receive_data,
