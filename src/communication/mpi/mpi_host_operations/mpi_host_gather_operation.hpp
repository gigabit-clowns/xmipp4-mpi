...
/**
 * @brief Implementation of the gather operation.
 * 
 */
class mpi_host_gather_operation final
	: public mpi_host_operation
{
public:
	explicit mpi_host_gather_operation(
	...
	~mpi_host_gather_operation() override = default;
